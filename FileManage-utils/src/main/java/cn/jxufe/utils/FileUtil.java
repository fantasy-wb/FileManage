...
public class FileUtil {
     ...
     * @return ResponseBo
     */
    public static BaseResult createExcelByPOIKit(String filename, List<?> list, Class<?> clazz) {

        if (list.isEmpty()) {
            return BaseResult.buildFail("导出数据为空！");
        } else {
            ...
            if (operateSign) {
                return BaseResult.buildSuccess(fileName);
            } else {
     ...
     * @return ResponseBo
     */
    public static BaseResult createCsv(String filename, List<?> list, Class<?> clazz) {
        ...
        if (list.isEmpty()) {
            ...
            if (operateSign) {
                ...
                return BaseResult.buildSuccess("导出Csv失败，请联系网站管理员！");
            }
        }
    }
